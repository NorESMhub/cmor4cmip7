module m_jsons
  ...
  integer,parameter   :: slenmax = 120

contains

  ! -----------------------------------------------------------------

  subroutine json_get_keys(fnm,path,keys,found,separator)
  ...
  subroutine json_get_value(fnm, path, str, found, separator)
  ...
  subroutine json_get_array_string(fnm,path,array,found,separator)
  ...
  subroutine json_get_array_real(fnm,path,array,found,separator)
  ...
  subroutine json_get_vertcoord(tnm, vnm, str, found, separator)
  ...
  subroutine json_get_vunits(tnm, vnm, units, found, separator)
